...
list(
  ...
  tar_target(simpleStates, command = merge_formatted_indState_data(reformatted_data,
                                                         updatedCrosswalks,
                                                         existingCrosswalks),
             pattern = map(reformatted_data),
             iteration = "list"),
  tar_target(NonSWUDSdata, command = merge_formatted_allState_data(simpleStates,
                                                         updatedCrosswalks)),
  ...
  tar_target(WriteStates, command = write_indstates(IndStates), pattern = map(IndStates)),
