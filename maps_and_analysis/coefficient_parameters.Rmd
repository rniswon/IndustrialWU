...
for (year in years){
  for (naics in naics_list) {
    ...
    boreo_and_pasqualini_map <- ggplot(boreo_and_pasqualini_sf) +
      ...
      labs(title = paste0("Coefficient Values for ", naics, ' ', year, 'in gal/ dollar of gdp'), fill = "Coefficient Value") +
      theme_void()
    
    if (export_figures) 
      {export_figure(boreo_and_pasqualini_map,'../outputs/', paste0(year, '_', naics), 10, 5)
} 
