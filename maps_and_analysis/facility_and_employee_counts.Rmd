...
inwu_facility_csv <- paste0(inwu_model_folder,
                            "/INWU_task_folders/Site_selection/Industrial_site_list/USEPA_HIFLD_EIA_PPP_facility_v7.csv")
...
populate_coords_cty_centroid <- function(input_df, lat_field, long_field, GNIS_layer) {
...
inwu_facility_df <- populate_coords_cty_centroid(inwu_facility_df, 'LATITUDE', 'LONGITUDE', GNIS_path)
...
if (export_figures) {
  ...
  export_figure(nationwide_emp_summary_plot, output_dir, 'nationwide_emp_summary_plot', 10, 5, svg_output=FALSE)
...
if (export_figures) {
  ...
  export_figure(nationwide_estab_summary_plot, output_dir, 'nationwide_estab_summary_plot', 10, 5, svg_output=FALSE)
...
if (export_figures) {
  ...
  export_figure(summary_emp_county_boxplot, output_dir, 'summary_emp_county_boxplot', 10, 5, svg_output=FALSE)
...
if (export_figures) {
  ...
  export_figure(summary_estab_county_boxplot, output_dir, 'summary_estab_county_boxplot', 10, 5, svg_output=FALSE)
